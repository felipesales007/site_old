                    ...
                    <div class="perfil-card">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input required tabindex="1" maxlength=15 id="login-nome" name="usuarios_nome" placeholder="Primeiro nome" class="form-control" type="text" onKeypress="return somente_letras(event)" onkeydown="maiuscula('login-nome')" value="<?= $usuarios_nome ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input required tabindex="2" maxlength=15 id="login-sobrenome" name="usuarios_sobrenome" placeholder="Sobrenome" class="form-control" type="text" onKeypress="return somente_letras(event)" onkeydown="maiuscula('login-sobrenome')" value="<?= $usuarios_sobrenome ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input required tabindex="3" maxlength="6" id="login-matricula" name="usuarios_matricula" placeholder="Matrícula" class="form-control zero-esquerda" type="number" value="<?= $usuarios_matricula ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <i id="chamado-i" class="pull-right fa fa-question-circle fa-2x" data-toggle="tooltip" data-placement="top" title="Preencher com o seu telefone ou do seu setor de trabalho, por exemplo, 07134455667"></i>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-phone-alt"></i></span>
                                    <input required tabindex="4" maxlength=11 id="login-telefone" name="usuarios_telefone" placeholder="Telefone" class="form-control" type="tel" onclick="auto_numero()" onfocus="this.selectionStart = this.selectionEnd = 500" onblur="if(this.value == '071') {this.value = '';}" value="<?= $usuarios_telefone ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <i id="chamado-i" class="pull-right fa fa-question-circle fa-2x" data-toggle="tooltip" data-placement="top" title="Preencher com outro telefone para contato, se houver, por exemplo, 071988776655"></i>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                    <input tabindex="5" maxlength=12 id="login-celular" name="usuarios_celular" placeholder="Celular (opcional)" class="form-control" type="tel" onclick="auto_numero_opcional()" onfocus="this.selectionStart = this.selectionEnd = 500" onblur="if(this.value == '071') {this.value = '';}" value="<?= $usuarios_celular ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input tabindex="6" maxlength=40 id="login-email" name="usuarios_email" placeholder="E-mail (opcional)" class="form-control" type="email" value="<?= $usuarios_email ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input tabindex="7" maxlength="10" id="login-data-nascimento" name="usuarios_data_nascimento" placeholder="Nascimento (opcional)" class="datepicker form-control" type="text" onKeypress="formatar_data('99/99/9999', this)" value="<?= $usuarios_data_nascimento ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input required tabindex="8" maxlength="11" id="login-cpf" name="usuarios_cpf" placeholder="CPF" class="form-control" type="tel" value="<?= $usuarios_cpf ?>" onkeyup="this.value = sem_espaco(this.value)">
                                </div>
                            </div>
                        </div>
                ...
                <form id="validador-6" class="well form-horizontal" method="POST" action="../../controllers/sistema/perfil-alterar-senha.php" onsubmit="return carregando_senha_atualizar(this)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input required tabindex="12" minlength=6 maxlength=10 id="login-senha-atual" name="usuarios_senha_atual" placeholder="Senha" class="form-control" type="password" onKeypress="return somente_letras_numeros(event)" onkeyup="this.value = sem_espaco(this.value)">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fas fa-key"></i></span>
                                <input required tabindex="13" minlength=6 maxlength=10 id="login-senha" name="usuarios_senha_criar" placeholder="Nova senha" class="form-control" type="password" onKeypress="return somente_letras_numeros(event)" onkeyup="this.value = sem_espaco(this.value)">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fas fa-key"></i></span>
                                <input required tabindex="14" minlength=6 maxlength=10 id="login-senha-repetir" name="usuarios_senha_repetir" placeholder="Confirmação de senha" class="form-control" type="password" onKeypress="return somente_letras_numeros(event)" onkeyup="this.value = sem_espaco(this.value)">
                            </div>
                        </div>
                    </div>
