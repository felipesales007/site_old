<?php
	...
	if ($usuarios_permissao_id <= 2 && $usuario_setor['usuarios_setor_id'] == $usuarios_setor_id && $usuarios_status_id == 1) {
?>
<html>
	<head>
				...
				<form id="validador" method="POST" class="well form-horizontal">
					...
					<div class="perfil-card">
						...
						<div class="footer text-center chamado-btn-ajuste">
							<button tabindex="4" id="enter" class="btn btn-success btn-ms f-btn-success" data-toggle="modal" data-target="#modal-alterar-usuario" data-id="<?= $usuario_setor['usuarios_id'] ?>">Alterar</button>
						</div>
					</div>
				</form>
			<!-- /Formulário -->
