...
CREATE TABLE IF NOT EXISTS usuarios (
  ...
  usuarios_data_nascimento VARCHAR(255) NOT NULL,
...
-- Insere na tabela de historico o log de novo feedbacks
...
-- Insere na tabela de historico o log de exclusão de feedback 
...
-- Insere na tabela de historico o log de novo chamados
...
-- Insere na tabela de histórico as alterações de chamados
