					...
					<section class="tab-content">	
						<section class="tab-pane active fade in content" id="">
							<div class="row">
								<!-- Corpo -->
									<div>
										<form class="well form-horizontal" action="banco/remove-chamado.php" method="POST" id="contact_form">
											<fieldset>
												<!-- Tabela titulo -->
													...
													<!-- Botão -->
                                                        ...
                                                        <center>
															...
															<div class="form-group">
																...
																<div class="col-md-4">
																	<a tabindex="7" class="btn btn-primary button btn-block" href="formulario-alterar?id=<?=$lista['id']?>"><i class="fa fa-pencil-square-o"></i><b> Alterar</b></a>
																	<br>
