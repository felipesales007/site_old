...
<html>
    ...
    <!-- Lista todos -->
        <div class="tab">
            ...
            <a style="color:#32cd99;" href="lista-resolvidos"><button tabindex="3" title="Resolvidos"><i class="fa fa-thumbs-o-up fa-2x"></i><b class="hidden-xs"> Resolvidos</b></button></a>
            <button style="color:#4d4d4d;" tabindex="4" onclick="openCity(event, 'todos')" id="defaultOpen" title="Todos"><i class="fa fa-sort-amount-desc fa-2x"></i><b class="hidden-xs"> Todos</b></button>
            <i id="contador"><?php echo count($chamados = listaChamado($conexao)) ?></i><i id="contador-n">nº </i>
        </div>
        ...
        <div id="todos" class="tabcontent">
            ...
            <?php
                if(count($chamados = listaChamado($conexao)) <= 12 ) {
                    echo "<table>";
                }
                if(count($chamados = listaChamado($conexao)) > 12 ) {
            ...
            ?>
                <thead>
                    <tr>
                        ...
                        <th class="text-left hidden-xs"><center>Resolvido?</center></th>
                        ...
                        <table class="table-fill" id="dev-table">
                            ...
                            <tbody class="table-hover">
                                <tr>
                                    ...
                                    <?php
                                        if ($lista['categoria_nome'] == 'Pendente') {                                   
                                            echo "<td class='text-left hidden-xs' style='background:#CFB53B;'><center>Pendente</center></td>";
                                        }
